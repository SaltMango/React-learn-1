  ...
  _createClass(Indecision, [{
    ...
    value: function handleDeleteOption(option) {
      this.setState(function (preState) {
        return {
          options: preState.options.filter(function (item) {
            return option !== item;
          })
        };
      });
    ...
    value: function handlePick() {
      ...
      var selection = this.state.options[randomNumber];
      this.setState(function () {
...
var AddOption = function (_React$Component2) {
  ...
  _createClass(AddOption, [{
    ...
    value: function handleAddOption(e) {
      e.preventDefault();
      var newValue = e.target.elements.newOption.value.trim();
      var error = this.props.handleAddOption(newValue);
      this.setState(function () {
        return { error: error };
      });
